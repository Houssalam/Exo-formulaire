...
var tabInscription = document.querySelector("nav li:nth-child(2) a");
...
form.addEventListener("submit", (e) => {
  ...
  form_verify();
  tabInscription.classList.remove("disabled");
});
...
function form_verify() {
  ...
  // pwd confirm
  if (pwd2Value === "") {
    let message = "Le pswrd de confirmation ne peut pas être vide";
...
fetch("https://dummyjson.com/products")
  ...
  .then((data) => {
    ...
    data.forEach((item) => {
      ...
      titleCell.setAttribute("data-title", "Title");
      descriptionCell.setAttribute("data-title", "Description");
      priceCell.setAttribute("data-title", "Price");
      stockCell.setAttribute("data-title", "Stock");
      categoryCell.setAttribute("data-title", "Category");
      thumbnailCell.setAttribute("data-title", "Thumbnail");
      imagesCell.setAttribute("data-title", "Images");
      ...
      thumbnailCell.innerHTML = item.thumbnail;
      // imagesCell.innerHTML = item.images;
    });
  })
